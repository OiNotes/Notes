...
export default function MusicLayout({
  ...
  return (
    <html lang="ru" suppressHydrationWarning className="h-full w-full overflow-hidden overscroll-none">
      <head>
      ...
      <body className="bg-[#050505] h-full w-full overflow-hidden overscroll-none">
        {children}
      </body>
    </html>
  );
